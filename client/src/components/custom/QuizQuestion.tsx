     ...
     <Card className="shadow-sm">
      <CardContent className="text-left py-5 flex flex-col gap-y-4 relative">
         ...
         <div className="w-full relative">
          ...
          className={"border-x-0 border-t-0 shadow-none rounded-none focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 border-b border-gray-300 dark:border-gray-800 px-0 focus:border-violet-500 text-sm"} /> 
      ...
      {!isCorrect && isCompleted && <CardFooter className="py-4 border-t flex-col items-start gap-y-2 text-left">
        <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Correct answer</span>
