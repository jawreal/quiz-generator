...
const QuizProgress = (props: IProps) => {
  ...
  return (
     <Fragment>
       ...
       <div className={cn("mt-4 flex flex-col items-start gap-y-2 sticky top-0 bg-white dark:bg-gray-950 z-10 py-2 transition-all", !progressInView && "py-3 pb-4 border-b border-gray-300 dark:border-gray-800")}>
         <span className="font-medium self-start text-sm text-gray-500 dark:text-gray-400">{!quizCompleted ? `${questionsLeft} question/s left` : "Quiz completed!"}</span> 
